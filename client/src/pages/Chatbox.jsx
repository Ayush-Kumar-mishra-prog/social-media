      ...
      <div className="px-4">
        <div className="flex items-center gap-3 pl-5 p-1.5 bg-white w-full max-w-xl mx-auto border-gray-200 shadow rounded-full mb-5">
          ...
          <label htmlFor="image" className="">
            {
              image ? <img src={URL.createObjectURL(image)} alt="" className="h-8 rounded" /> :<Image className='size-7 text-gray-400 cursor-pointer' />
            }
            <input type="file" id="image" accecpt="image/*" hidden className="" onChange={(e)=>setImage(e.target.files[0])} />
          </label>

...
const UserProfileInfo = ({user,post,profileId,setShowEdit}) => {
  return (
    <div className='relative py-4 px-6 md:px-8 bg-white'>
        <div className="flex flex-col md:flex items-centergap-6">
            ...
            <div className="w-full pt-16 md:pt-0 md:pl-36">
                <div className="flex flex-col md:flex-row items-start justify-between">
                    ...
                    {
                        !profileId && <button  onClick={()=>setShowEdit(true)} className=" cursor-pointer flex items-center gap-2 border border-gray-300 hover:bg-gray-50 px-4 py-2 rounded-lg font-medium transition transition-colors mt-4 md:mt-0"><PenBox className='w-4 h-4'/> Edit</button>
                    }
                </div>
                ...
                <div className="flex items-center gap-6 mt-6 border-t border-gray-200 pt-4">
                    <div className="">
                        <span className="sm:texl-xl font-bold text-gray-900">
                            {post.length}
                        </span>
